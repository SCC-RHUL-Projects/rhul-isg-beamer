...
\newenvironment{slideSet}[1]{\section{#1}}{}
...
\begin{slide*}{Presentation Contents}
	\tableofcontents
\end{slide}

\begin{slideSet}{Title Page}
\begin{slide}{RHUL Title Page}
\begin{itemize}
...
\begin{slideSet}{Table of Contents}
\begin{slide}{Showing Progress Through the Presentation}
\begin{itemize}
...
\begin{slideSet}{Example Slides}
\begin{slide}{Invisible Covering/Uncovering of Content}
\begin{itemize}
...
\begin{slide}{Transparent Covering/Uncovering}
\begin{itemize}
	\item I'm the first item!
	\pause
...
\begin{slideSet}{One more thing}
\begin{slide}{A quirk of the ISG style}
\begin{itemize}
